...
python datanoisy.py --rate 0.6  --dataset trec --result_dir noisy_data --type random --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset trec --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset trec --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset trec --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset trec --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset trec --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset trec --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset trec --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset trec --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset trec --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset trec --result_dir noisy_data --type white --seed 0 --random_state 0
...
python datanoisy.py --rate 0.6  --dataset agnews --result_dir noisy_data --type random --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset agnews --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset agnews --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset agnews --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset agnews --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset agnews --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset agnews --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset agnews --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset agnews --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset agnews --result_dir noisy_data --type uniform --seed 0 --random_state 0
...
python datanoisy.py --rate 0.4  --dataset chn --result_dir noisy_data --type random --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chn --result_dir noisy_data --type random --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chn --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chn --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chn --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chn --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chn --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chn --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chn --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chn --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chn --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chn --result_dir noisy_data --type white --seed 0 --random_state 0
...
python datanoisy.py --rate 0.6  --dataset chngolden --result_dir noisy_data --type random --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chngolden --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chngolden --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chngolden --result_dir noisy_data --type symmetric --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chngolden --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chngolden --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chngolden --result_dir noisy_data --type pairflip --seed 0 --random_state 0
python datanoisy.py --rate 0.2  --dataset chngolden --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.4  --dataset chngolden --result_dir noisy_data --type uniform --seed 0 --random_state 0
python datanoisy.py --rate 0.6  --dataset chngolden --result_dir noisy_data --type uniform --seed 0 --random_state 0
...
>>>>>>> f152b4d7c9c7acfd0b19a8673844e3c7b98e6828
